...
import { ArrowLeft, ExternalLink, Shield, Lock, FileCheck, AlertTriangle, CheckCircle2, Search, FileText, Users } from 'lucide-react';

const ISO27001Project = () => {
  ...
  const technologies = [
    {
      name: 'Vue.js 3',
      description: 'Framework moderno para interfaz de usuario reactiva',
      icon: FileText,
    },
    {
      name: 'Python & Django',
      description: 'Backend robusto para gestión de seguridad',
      icon: Lock,
    },
    {
      name: 'PostgreSQL',
      description: 'Base de datos relacional segura y escalable',
      icon: Shield,
    },
    {
      name: 'Celery & Redis',
      description: 'Procesamiento asíncrono y caché',
      icon: AlertTriangle,
    },
  ];

  const features = [
    'Gestión completa de controles ISO 27001',
    ...
    'Sistema de documentación centralizada',
    'Gestión de activos de información',
    'Calendario de auditorías',
    'Portal de capacitación en seguridad',
  ];

  const stats = [
    { label: 'Controles Gestionados', value: '114' },
    { label: 'Tiempo de Auditoría', value: '-70%' },
    { label: 'Cumplimiento', value: '98%' },
    { label: 'Empresas Certificadas', value: '+50' },
  ];
    ...
    <div className="min-h-screen bg-metal-950">
        ...
        <div className="section-container relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 px-4 py-2 glass-premium rounded-full border border-white/10 mb-6">
              ...
              <span className="text-sm font-medium text-metal-300">Ciberseguridad</span>
            </div>

            <h1 className="text-5xl lg:text-7xl font-display font-bold mb-6">
              <span className="block text-white">Portal ISO 27001</span>
              <span className="block gradient-text-premium">Sistema de Gestión de Seguridad</span>
            </h1>

            <p className="text-xl text-metal-300 leading-relaxed mb-8">
              Plataforma completa para{' '}
              <span className="text-white font-semibold">gestión de seguridad de la información</span>
              {' '}con módulos de auditoría, evaluación de riesgos, gestión de controles y generación
              automatizada de reportes de cumplimiento normativo ISO 27001.
            </p>
          ...
          >
            <img src={images[0]} alt="Portal ISO 27001" className="w-full h-auto" />
        ...
        <div className="section-container relative z-10">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-display font-bold mb-4">
              Tecnologías <span className="gradient-text-premium">Seguras</span>
            </h2>
          </motion.div>
      ...
      <section className="py-20">
        <div className="section-container">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-display font-bold mb-4">
              Módulos <span className="gradient-text-premium">Especializados</span>
            </h2>
          </motion.div>
      ...
      <section className="py-20 relative">
        ...
        <div className="section-container relative z-10">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-display font-bold mb-4">
              Capturas del <span className="gradient-text-premium">Sistema</span>
            </h2>
          </motion.div>
        ...
        <div className="section-container">
          ...
          >
            <h2 className="text-3xl lg:text-5xl font-display font-bold mb-6">
              ¿Listo para <span className="gradient-text-premium">certificar ISO 27001</span>?
            </h2>
            <p className="text-xl text-metal-300 mb-8 max-w-2xl mx-auto">
              Gestiona la seguridad de tu información con nuestra plataforma especializada
            </p>
...
export default ISO27001Project;
